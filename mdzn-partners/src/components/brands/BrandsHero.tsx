        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
          ...
          <div>
            ...
            <div className="flex flex-col lg:flex-row gap-3 lg:gap-4">
              <button className="w-full lg:w-auto bg-white text-primary-900 px-8 py-4 rounded-xl font-semibold text-lg hover:bg-primary-50 hover:shadow-[0_0_0_3px_rgba(212,175,55,0.3)] transition-all duration-200 shadow-lg">
                Demo Talep Et
              </button>
              <button className="w-full lg:w-auto border border-white/30 text-white px-8 py-4 rounded-xl font-semibold text-lg hover:bg-white/10 hover:border-accent-600 transition-all duration-200">
                Nasıl Çalışır?
              </button>
            </div>
          </div>
